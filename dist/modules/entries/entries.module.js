...
exports.EntriesModule = EntriesModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: entries_model_1.Entry.name, schema: entries_model_1.EntrySchema }]),
        ],
        controllers: [entries_controller_1.EntriesController],
        providers: [entries_service_1.EntriesService, entries_repository_1.EntriesRepository],
    })
], EntriesModule);
